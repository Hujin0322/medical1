...
-- 테이블 구조 및 데이터 모두 복사
-- employees의 모든 것을 가져와 emp02에 만들기
...
-- 기존 테이블 구조만 복사
-- 조건에 맞는 데이터는 없지만 구조만 가져오기
create table emp03 as
select *from employees where 1=2;

-- 테이블 이미 존재, 데이터만 복사 (구조 다른 경우)
